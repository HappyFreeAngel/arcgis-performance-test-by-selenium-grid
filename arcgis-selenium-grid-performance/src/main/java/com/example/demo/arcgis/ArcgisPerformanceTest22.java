...
//
//public class ArcgisPerformanceTest22 {
//
//
//    public static void main(String[] args) throws Exception {
//
//        int localExplorerCount=1;
//        String windowsDriverPath="c:\\chrome";
//        //System.setProperty("webdriver.chrome.logfile", "/tmp/chromedriver.log");
//        //System.setProperty("webdriver.chrome.verboseLogging", "true");
//
//        if(args!=null && args.length==2){
//            localExplorerCount = Integer.parseInt(args[0]);
//            windowsDriverPath= args[1];
//        }
//
//        ArcgisPerformanceTest22 test = new ArcgisPerformanceTest22();
//        String driverType="chrome";
//        //String driverType="firefox";
//
//        //1.本地测试，方便初期验证测试方法是否正确.
//        for(int i=0;i<localExplorerCount;i++) {
//            //new Thread(()-> test.localTask(driverType)).start();
//            new Thread(()-> test.localTask("chrome")).start();
//            test.waitFor(100);
//        }
...
////            new Thread(()-> test.remoteTask(Platform.LINUX,driverType)).start();
////            test.waitFor(1000);
////        }
//    }
//
//
//    public void remoteTask(Platform platform,String driverType){
//
//        String seleniumGridHubURL="http://11.23.3.114:4444/wd/hub";
//        try {
//            WebDriver webDriver = getRemoteDriver(platform,driverType, seleniumGridHubURL);
//            //String entryURL = "http://11.23.3.114:8777/index.html";
//            String entryURL="http://11.23.3.117/map.html";
...
//     * @throws Exception
//     */
//    public WebDriver getRemoteDriver(Platform platform,String driverType,String seleniumGridHubURL) throws Exception {
//
...
//            Thread.sleep(4000);
//            System.out.println(entryURL+" 加载成功."+webDriver.getTitle());
